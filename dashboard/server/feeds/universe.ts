...
"AAOI","ABCL","ABNB","ABSI","ACHC","ACHR","AEHR","AFRM","AI","AIP",
"ALAB","ALGM","AMBQ","AMC","AMPG","AMSC","ANF","AOSL","APPS","ARM",
"ASTS","ASX","ASYS","AXSM","AXTI","BAND","BB","BBAI","BBWI","BDC",
"BE","BEAM","BFLY","BNTX","BKKT","BROS","BRUM","BTBT","BW","BWEN",
"BWXT","CAN","CAVA","CCJ","CELH","CERE","CIFR","CLS","CLSK","COMP",
"CORZ","COUR","CRDO","CRSP","CRWV","CZR","DGXN","DJT","DKNG","DNN",
"DOCN","DUOL","EH","ELF","ENPH","EOSE","FCEL","FN","FROG","FSLR",
"GAME","GH","GLXY","HUT","HYLN","ICHR","INHD","INIO","IONQ","IOT",
"IPWR","IREN","JBL","JBLU","JOBY","KEEL","KRKNF","KSS","KTOS","LAC",
"LASE","LCID","LEU","LFUS","LUNR","MARA","MDA","MDB","MEDP","MGNI",
"MOD","MRNA","MSTR","MXL","NAVN","NBIS","NU","NVTS","NWL","OKLO",
"OKTA","ON","ONDS","OPEN","OSCR","PACB","PBF","PENG","PLUG","POET",
"POWI","QBTS","QNT","QTEX","QUBT","QUCY","RBLX","RDDT","RELL","RELY",
"RGNT","RGTI","RHI","RIOT","RIVN","RKLB","RLAY","ROKU","RXRX","SDGR",
"SEDG","SHAZ","SHOP","SLNH","SMR","SNAP","SNOW","SOFI","SOUN","SPOT",
"SQ","STI","STUB","TEAM","TEM","TENB","TOST","TSEM","TWLO","TXG",
...
// Static baseline of majors + liquid alts. Augmented at runtime by the
// dynamic Binance top-N pull (see binance.ts) so the universe stays current
...
export const CRYPTO_UNIVERSE = [
  ...
  // DeFi / infra
  "JUPUSDT","PYTHUSDT","ONDOUSDT","ENAUSDT","AEROUSDT","JTOUSDT",
  "STXUSDT","KASUSDT","ZROUSDT","ETHFIUSDT","EIGENUSDT","GMXUSDT",
  "RAYUSDT","KSMUSDT","XTZUSDT","IMXUSDT","RNDRUSDT","CAKEUSDT",
  "1INCHUSDT","BALUSDT","SUSHIUSDT","YFIUSDT","LRCUSDT","ZECUSDT",
  "DASHUSDT","NEOUSDT","WAVESUSDT","ANKRUSDT","CELOUSDT","KAVAUSDT",
  // L1s / L2s / new entrants
  "TONUSDT","APTUSDT","SEIUSDT","SUIUSDT","TIAUSDT","MANTAUSDT",
  "STRKUSDT","METISUSDT","LDOUSDT","OPUSDT","ARBUSDT","MATICUSDT",
  "POLUSDT","AVAXUSDT","NEARUSDT","FTMUSDT","SUIUSDT","SEIUSDT",
  // AI / DePIN / RWA
  "RNDRUSDT","FETUSDT","OCEANUSDT","AGIXUSDT","WLDUSDT","TAOUSDT",
  "ARKMUSDT","IOUSDT","AKTUSDT","ARUSDT","RENDERUSDT","LPTUSDT",
  "ONDOUSDT","RIOUSDT","RPLUSDT","GALAUSDT",
  // Memes / culture
  "PEPEUSDT","WIFUSDT","BONKUSDT","FLOKIUSDT","POPCATUSDT","MEMEUSDT",
  "TURBOUSDT","BABYDOGEUSDT","SHIBUSDT","DOGEUSDT","FOMOUSDT","NEIROUSDT",
  // Additional popular
  "MORPHOUSDT","BLURUSDT","PUMPUSDT","PENGUUSDT","ORDIUSDT",
  "JSTUSDT","SPELLUSDT","EGLDUSDT","APEUSDT","HMSTRUSDT","GRAMUSDT",
  "GUNUSDT","THEUSDT","SYNUSDT","SKLUSDT","DEXEUSDT",
]
